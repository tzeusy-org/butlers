...
const _SHELL_CAPABILITIES_INPUT: readonly ShellCapabilityInput[] = [
  ...
  { path: "/chat", label: "Chat", keywords: ["chat", "switchboard", "conversation", "talk to butlers"], family: "overview", placement: null, chord: "l", discoverability: "global", loader: page(() => import("@/pages/ChatPage.tsx")) },
  ...
  { path: "/qa", label: "QA", keywords: ["quality", "patrol"], family: "operations", placement: { section: "Main", order: 2, butler: "qa", badgeKey: "qa-escalations", badgeVariant: "red", icon: "qa" }, chord: "q", discoverability: "global", loader: page(() => import("@/pages/QaOverviewPage.tsx")) },
  ...
  { path: "/entities", label: "Entities", keywords: ["people", "relationships", "plex"], family: "relationship", placement: { section: "Main", order: 7, icon: "entities" }, chord: "u", discoverability: "global", loader: page(() => import("@/components/relationship/PlexPage.tsx")) },
  { path: "/secrets", label: "Secrets", keywords: ["credentials", "keys"], family: "settings", placement: { section: "Main", order: 8, icon: "secrets" }, chord: "k", discoverability: "global", loader: page(() => import("@/pages/SecretsPage.tsx")) },
  { path: "/settings", label: "Settings", keywords: ["configuration", "preferences"], family: "settings", placement: { section: "Main", order: 9, icon: "settings" }, chord: "w", discoverability: "global", loader: page(() => import("@/pages/SettingsConsolePage.tsx")) },

  { path: "/education", label: "Education", keywords: ["learning", "study"], family: "butler", placement: { section: "Dedicated Butlers", order: 0, butler: "education" }, chord: "y", discoverability: "global", loader: page(() => import("@/pages/EducationPage.tsx")) },
  ...
  { path: "/calendar", label: "Calendar", keywords: ["schedule", "events"], family: "butler", placement: { section: "Dedicated Butlers", order: 2 }, chord: "v", discoverability: "global", loader: page(() => import("@/pages/CalendarWorkspacePage.tsx")) },
  { path: "/chronicles", label: "Chronicles", keywords: ["retrospective", "lived time"], family: "butler", placement: { section: "Dedicated Butlers", order: 3, butler: "chronicler", tooltip: "Retrospective lived-time reconstruction" }, chord: "z", discoverability: "global", loader: page(() => import("@/pages/ChroniclesPage.tsx")) },
  ...
  { path: "/spend", label: "Spend", keywords: ["costs", "forecast", "usage"], family: "telemetry", placement: { section: "Telemetry", order: 4, icon: "spend" }, chord: "x", discoverability: "global", loader: page(() => import("@/pages/SpendPage.tsx")), queryWarmup: staticWarmup("/spend", ["spend-forecast"], fetchSpendForecast) },
  ...
  { path: "/system", label: "System", keywords: ["instance", "runtime"], family: "telemetry", placement: { section: "Telemetry", order: 6, icon: "system", tooltip: "Instance ownership and runtime facts" }, chord: "j", discoverability: "global", loader: page(() => import("@/pages/SystemPage.tsx")) },

  { path: "/health/measurements", label: "Measurements", keywords: ["health", "vitals"], family: "butler", placement: { section: "Dedicated Butlers", order: 10, group: "Health", butler: "health" }, chord: "0", discoverability: "global", loader: page(() => import("@/pages/MeasurementsPage.tsx")) },
  { path: "/health/medications", label: "Medications", keywords: ["health", "prescriptions"], family: "butler", placement: { section: "Dedicated Butlers", order: 11, group: "Health", butler: "health" }, chord: "1", discoverability: "global", loader: page(() => import("@/pages/MedicationsPage.tsx")) },
  { path: "/health/conditions", label: "Conditions", keywords: ["health", "diagnoses"], family: "butler", placement: { section: "Dedicated Butlers", order: 12, group: "Health", butler: "health" }, chord: "2", discoverability: "global", loader: page(() => import("@/pages/ConditionsPage.tsx")) },
  { path: "/health/symptoms", label: "Symptoms", keywords: ["health", "signs"], family: "butler", placement: { section: "Dedicated Butlers", order: 13, group: "Health", butler: "health" }, chord: "3", discoverability: "global", loader: page(() => import("@/pages/SymptomsPage.tsx")) },
  { path: "/health/meals", label: "Meals", keywords: ["health", "nutrition"], family: "butler", placement: { section: "Dedicated Butlers", order: 14, group: "Health", butler: "health" }, chord: "4", discoverability: "global", loader: page(() => import("@/pages/MealsPage.tsx")) },
  { path: "/health/research", label: "Research", keywords: ["health", "studies"], family: "butler", placement: { section: "Dedicated Butlers", order: 15, group: "Health", butler: "health" }, chord: "5", discoverability: "global", loader: page(() => import("@/pages/ResearchPage.tsx")) },

  { path: "/settings/permissions", label: "Permissions", keywords: ["settings", "access"], family: "settings", placement: null, chord: "6", discoverability: "global", loader: page(() => import("@/pages/SettingsPermissionsPage.tsx")) },
  { path: "/settings/models", label: "Models", keywords: ["settings", "runtime"], family: "settings", placement: null, chord: "7", discoverability: "global", loader: page(() => import("@/pages/SettingsModelsPage.tsx")) },
  { path: "/entities/index", label: "Entities Index", keywords: ["entities", "contacts", "people"], family: "relationship", placement: null, chord: "8", discoverability: "global", loader: page(() => import("@/components/relationship/EntitiesIndexPage.tsx").then(({ EntitiesIndexPage }) => ({ default: EntitiesIndexPage }))) },
  ...
  { path: "/entities/concentration", label: "Concentration", keywords: ["entities", "network"], family: "relationship", placement: null, chord: "9", discoverability: "global", loader: page(() => import("@/components/relationship/ConcentrationPage.tsx")) },
  { path: "/entities/circles", label: "Circles", keywords: ["entities", "groups", "relationships"], family: "relationship", placement: null, chord: "-", discoverability: "global", loader: page(() => import("@/components/relationship/CirclesPage.tsx")) },
