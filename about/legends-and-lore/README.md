...
| [0033](rfcs/0033-fleet-cost-claims.md) | Fleet Cost Claims | **Implemented — Slices 1–3.** Typed sibling-asserted money claims, role-fenced Finance verdicts, and honest reconciliation coverage. |
| [0034](rfcs/0034-messenger-voice-egress.md) | Messenger-Owned Voice Egress | **Draft.** Messenger-owned, authenticated, local-first in-room voice delivery with explicit-only initiation, fresh room presence, unconditional DND/quiet suppression, physical-side-effect replay fencing, one linked text fallback, and content-blind retention. Exact-artifact review and owner approval pending. |
| [0035](rfcs/0035-bounded-post-delivery-approval-reminders.md) | Bounded Post-Delivery Approval Reminders | **Proposed; Direction B selected, exact policy not adopted.** Allows at most two distinct-channel reminders after provider-confirmed approval delivery without action-specific owner acknowledgement, while preserving expiry, quiet-hours, burst, ambiguity, and human-decision boundaries. |
