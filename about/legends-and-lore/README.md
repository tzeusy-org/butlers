...
| [0033](rfcs/0033-extensible-channels-and-owner-device-bridge.md) | Extensible Channels and the Owner-Device Bridge | **Proposed — owner sign-off required.** Separates migration-owned inbound source-pair authority from outbound adapters, replaces interaction hour slots with source-aware identity, defines Watched Source, and reserves an inactive owner-device calls/SMS bridge behind exact provider, privacy, authentication, and egress gates. |
